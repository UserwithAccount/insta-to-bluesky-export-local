                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {weekPosts.map((post) => (
                                    <div key={post.id} className="bg-white dark:bg-zinc-800 rounded-lg shadow p-4 relative">
                                        ...
                                        <label className="block text-sm font-semibold mb-1 text-zinc-800 dark:text-zinc-200">Title</label>
                                        <textarea
                                            rows={4}
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (idx !== -1) updated[idx].title = e.target.value;
                                                setPosts(updated);
                                            }}
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                const updated = [...posts];
                                                const idx = updated.findIndex((p) => p.id === post.id);
                                                if (idx !== -1) updated[idx].scheduledTime = e.target.value;
                                                setPosts(updated);
                                            }}
